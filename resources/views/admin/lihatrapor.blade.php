                  ...
                  <tbody>
                    ...
                    @if ($data->mapel->kelompok != 'Kelompok A ( Umum )' )
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-left"><a href="" class="btn btn-warning btn-sm mr-1" data-toggle="modal" data-target="#ubah_rapor{{$data->kdmapelr}}"><i class="fa-solid fa-pen to-square mr-1"></i>Ubah</a>
                                <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_rapor{{$data->kdmapelr}}"><i class="fa-solid fa-trash to-square mr-1"></i>Hapus</a>
                            </td>
                        </tr>
                        @php
                            $i++;
                    ...
                    @foreach ($datar as $data)
                        <div class="modal fade" id="hapus_rapor{{$data->kdmapelr}}" tabindex="-1" role="dialog" aria-labelledby="hapus-siswa" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{url('Lnilaiadm')}}/{{$data->kdmapelr}}/{{$data->nis_rapor}}" method="POST">
                                            {{ csrf_field() }}
                        ...
                        <div class="modal fade" id="ubah_rapor{{$data->kdmapelr}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Ubah Data Rapor</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{url('Lnilaiadm')}}/{{$data->kdmapelr}}/{{$data->nis_rapor}}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="number" id="nilai" name="nilai" placeholder="Masukkan Nilai" class="form-control" required autocomplete="off" pattern="[a-zA-Z' ]+" value="{{$data->nilai}}">
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" id="ket" name="ket" placeholder="Masukkan Keterangam">{{$data->ket}}</textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
