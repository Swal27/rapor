        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">User Profil</p>
                  <h4 class="mb-4">Your Profil Identity</h4>
                  <h5 class="mb-4">Nis   : {{$siswa->nis_siswa}}</h5>
                  <h5 class="mb-4">Nama  : {{$siswa->nama}}</h5>
                  <h5 class="mb-4">Telp  : {{$siswa->telp}}</h5>
                  <h5 class="mb-4">Alamat  : {{$siswa->alamat}}</h5>
                </div>
              </div>
            </div>
            <div class="col-md-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Password Changes</p>
                  <h1>Your Privacy is a key</h1>
                  <form action="{{url('up')}}/{{$siswa->nis_siswa}}" method="PUT">
                    <label for="passold">Old Password</label>
                    <br>
                    <input type="password" id="passold" name="passold" required placeholder="Masukan Password Lama">
                    <br>
                    <label for="passnew">New Password</label>
                    <br>
                    <input type="password" id="passnew" name="passnew" required placeholder="Masukan Password Baru">
                    <br>
